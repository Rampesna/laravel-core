<div class="modal fade show" id="CompanyTransactionsModal" aria-modal="true" role="dialog" data-bs-modal-backdrop-opacity="0.1">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="row mb-5">
                    <div class="col-xl-6 mb-5">
                        <div onclick="updateCompany()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Firmayı Düzenle</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 mb-5">
                        <div onclick="createBranch()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Firmaya Şube Ekle</span>
                            </div>
                        </div>
                    </div>
                </div>
