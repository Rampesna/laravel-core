<div class="modal fade show" id="DepartmentTransactionsModal" aria-modal="true" role="dialog" data-bs-modal-backdrop-opacity="0.1">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <div class="row mb-5">
                    <div class="col-xl-4 mb-5">
                        <div onclick="updateDepartment()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                ...
                                <span class="text-dark ms-5">Departmanı Düzenle</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5">
                        <div onclick="createTitle()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Ünvan Ekle</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 mb-5">
                        <div onclick="deleteDepartment()" class="card py-0 cursor-pointer">
                            <div class="card-body">
                                <span class="menu-icon">
                                    <span class="svg-icon svg-icon-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                ...
                                <span class="text-dark ms-5">Departmanı Sil</span>
                            </div>
                        </div>
                    </div>
                </div>
